...
class Bill_App:
    def __init__(self,root):
     ...
     # Customer Name Label and Entry
      ...
      bath_txt = Entry(f2, width=10, textvariable=self.soap, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=0, column=1, padx=10, pady=10)
      # Face Cream
      ...
      Face_cream_txt = Entry(f2, width=10, textvariable=self.face_cream, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=1, column=1, padx=10, pady=10)
      # Face Wash
      ...
      Face_w_txt = Entry(f2, width=10, textvariable=self.face_wash, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=2, column=1, padx=10, pady=10)
      # Hair Spray
      ...
      Hair_s_txt = Entry(f2, width=10, textvariable=self.spray, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=3, column=1, padx=10, pady=10)
      # Hair Gel
      ...
      Hair_g_txt = Entry(f2, width=10, textvariable=self.gell, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=4, column=1, padx=10, pady=10)
      # Body Lotion
      ...
      body_txt = Entry(f2, width=10, textvariable=self.loshan, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=5, column=1, padx=10, pady=10)
      
      # Grocery Frame
      f3 = LabelFrame(self.root, text="Grocery Product", font=("times new roman", 15, "bold"), fg="gold", bg=bg_color)
      ...
      g1_txt = Entry(f3, width=10, textvariable=self.rice, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=0, column=1, padx=10, pady=10)
      # Food Oil
      ...
      g2_cream_txt = Entry(f3, width=10, textvariable=self.food_oil, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=1, column=1, padx=10, pady=10)
      # Daal
      ...
      g3_txt = Entry(f3, width=10, textvariable=self.daal, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=2, column=1, padx=10, pady=10)
      # Wheat
      ...
      g4_txt = Entry(f3, width=10, textvariable=self.wheat, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=3, column=1, padx=10, pady=10)
      # Sugar
      ...
      g5_txt = Entry(f3, width=10, textvariable=self.sugar, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=4, column=1, padx=10, pady=10)
      # Tea
      ...
      g6_txt = Entry(f3, width=10, textvariable=self.tea, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=5, column=1, padx=10, pady=10)
      ...
      c1_txt = Entry(f4, width=10, textvariable=self.maza, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=0, column=1, padx=10, pady=10)
      # Cock
      ...
      c2_cream_txt = Entry(f4, width=10, textvariable=self.cock, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=1, column=1, padx=10, pady=10)
      # Frooti
      ...
      c3_txt = Entry(f4, width=10, textvariable=self.frooti, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=2, column=1, padx=10, pady=10)
      # Thumbs Up
      ...
      c4_txt = Entry(f4, width=10, textvariable=self.thumbsup, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=3, column=1, padx=10, pady=10)
      # Limca
      ...
      c5_txt = Entry(f4, width=10, textvariable=self.limca, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=4, column=1, padx=10, pady=10)
      # Sprite
      ...
      c6_txt = Entry(f4, width=10, textvariable=self.sprite, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN, validate="key", validatecommand=(self.root.register(self.validate_numeric), '%P')).grid(row=5, column=1, padx=10, pady=10)
   ...
   #validation for cosmetics quantity
    def validate_numeric(self, value):
        """Allow only numbers."""
        return value.isdigit() or value == ""
  # validation for Grocery quantity
    def validate_numeric(self, value):
        """Allow only numbers."""
        return value.isdigit() or value == ""
  # validation for cold drink
    def validate_numeric(self, value):
        """Allow only numbers."""
        return value.isdigit() or value == ""
